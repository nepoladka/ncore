...
#define DEFAULT_VEC_END(NUM)        typedef vec##NUM<unsigned __int8> vec##NUM##ui8;    \
...
#define DEFAULT_VEC_OPERATORS(NUM)  __forceinline vec##NUM* ptr() { return this; }                              \
                                    __forceinline _t& operator[](unsigned long long idx) { return array[idx]; } \
...
#define VEC_2_CONSTRUCTOR           __forceinline vec2(_t x = _t(), _t y = _t())                            { axis.x = x; axis.y = y; }
#define VEC_3_CONSTRUCTOR           __forceinline vec3(_t x = _t(), _t y = _t(), _t z = _t())               { axis.x = x; axis.y = y; axis.z = z; }
#define VEC_4_CONSTRUCTOR           __forceinline vec4(_t x = _t(), _t y = _t(), _t z = _t(), _t w = _t())  { axis.x = x; axis.y = y; axis.z = z; axis.w = w; }
